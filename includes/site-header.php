...
<svg class="logo-img" aria-label="Brasil DNA" role="img" id="Camada_1" data-name="Camada 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1847.11 800.51">
  <defs>
    <style>
      ...
      .cls-4 { fill: #c9423f; }
      .cls-5 { fill: #f1ab18; font-family: Bungee, sans-serif; font-size: 270.55px; }
      .cls-6 { stroke: #fff; stroke-miterlimit: 10; stroke-width: 6px; }
    </style>
  </defs>
  <g>
  ...
  <text class="cls-5" transform="translate(710.64 552.69)"><tspan x="0" y="0">dn</tspan><tspan class="cls-3" x="405.55" y="0">a</tspan></text>
    ...
    <nav class="main-nav" id="mainNav" aria-label="Navegação principal">
      <a href="index.php#about-us" <?= $currentPage === 'about' ? 'class="is-active"' : '' ?>>About Us</a>
      <a href="news.php" <?= in_array($currentPage, ['news', 'post']) ? 'class="is-active"' : '' ?>>News</a>
      <a href="index.php#destinos" class="nav-cta">Explore Brazil</a>
    </nav>
