...
<header class="site-header" id="siteHeader">
  <div class="container header-inner">
    <a href="index.php" class="logo" aria-label="Brasil DNA — Home">
...
<nav class="main-nav" id="mainNav" aria-label="Navegação principal">
  <a href="about-us.php" <?= $currentPage === 'about' ? 'class="is-active"' : '' ?>>About Us</a>
  <a href="news.php" <?= in_array($currentPage, ['news', 'post']) ? 'class="is-active"' : '' ?>>News</a>
  <a href="index.php#clients" class="nav-cta">Explore Brazil</a>
</nav>
