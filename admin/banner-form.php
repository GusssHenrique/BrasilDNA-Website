    ...
    <div class="post-main-card">
      ...
      <div class="adm-form__group">
        <label class="adm-form__label" for="titulo">
          Título principal
          <span class="post-label-hint">(headline no banner — ex: Your trusted DMC in Brazil)</span>
        </label>
      ...
      <div class="adm-form__group">
        <label class="adm-form__label" for="subtexto">
          Tagline
          <span class="post-label-hint">(texto abaixo do logo — ex: Turn inspiration into itineraries)</span>
        </label>
