...
// Defaults caso stats_diario ainda não exista
...
// Totais por tipo para os KPI cards secundários
...
try {
    ...
    // KPI geral — período atual (todos os tipos)
    $stmt = $pdo->prepare("
    ...
    // Série diária separada por tipo para o gráfico
    $stmtS = $pdo->prepare("
        SELECT tipo, data,
    ...
    // stats_diario não existe ainda — mostra zeros sem quebrar
}
...
<!-- Gráfico — 3 linhas: views banner, views cliente, cliques -->
